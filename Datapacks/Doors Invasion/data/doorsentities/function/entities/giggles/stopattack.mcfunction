...
advancement grant @n[type=player,gamemode=!creative,gamemode=!spectator,tag=giggles.attacked] through doorsentities:doors/giggles/just_a_prank
tag @n[type=player,gamemode=!creative,gamemode=!spectator,tag=giggles.attacked] remove giggles.attacked
