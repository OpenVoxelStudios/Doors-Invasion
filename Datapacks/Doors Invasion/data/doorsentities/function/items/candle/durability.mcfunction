...
execute unless score @s candle matches 14..16 run return fail

scoreboard players add @s candle 1

execute if score @s candle matches 17 run return run function doorsentities:items/candle/clear
