scoreboard players remove raycast.max flashlight 1

execute if score raycast.max flashlight matches ..0 run return 0
...
execute positioned ~ ~ ~ if block ~ ~ ~ #air run function doorsentities:items/flashlight/raycast_place
...
execute positioned ^ ^ ^2 run function doorsentities:items/flashlight/raycast